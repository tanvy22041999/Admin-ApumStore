              ...
              <CCardBody>
                <CDataTable
                  ...
                  scopedSlots = {{
                    ...
                    'user': (item) => (
                      <td><img src={item.image ? item.image.publicUrl : INITIAL_IMAGE} style={{width:'8vw'}} className="rounded-circle" alt=""></img></td>
                    ),
                    'content': (item) => (
                      <td>
                    ...
                    (item)=>(
                      <td>
                        <CButton
                          onClick={() => this.onDeleteNoti(item.id)}
                          className="mr-1"
                          color="warning"
                        >
                          Xóa
