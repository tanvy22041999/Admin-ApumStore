...
const fields = ['image', 'name','slug', 'accessories', { key: 'actions', style: { width: '30%'} }]
              ...
              <CCardBody>
                <CDataTable
                  ...
                  scopedSlots = {{
                    ...
                    (item) => (
                      <td>
                        <img src={ item.image ? item.image.publicUrl : INITIAL_IMAGE } style={{width:'6vh'}} alt={item.name} />
                      </td>
                    ),
                    'slug': (item) => (
                      <td>{item.pathseo}</td>
                    ...
                    (item)=>(
                      <td>
                        <CButton
                          onClick={() => this.handleListProduct(item.id)}
