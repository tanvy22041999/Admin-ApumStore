                ...
                <CDataTable
                  ...
                  scopedSlots = {{
                    ...
                    (item)=>(
                      <td>
                        <CButton
                          onClick={() => this.handleRedirect(item.id, '/users/order-manage')}
                        ...
                        <CButton
                          onClick={() => this.handleRedirect(item.id, '/users/installment-manage')}
                          className="mr-1 mb-1 mb-xl-0"
                          color="warning"
                        >
                          Trả góp
                        ...
                        <CButton
                          onClick={() => this.onSubmit(item.id, item.role)}
