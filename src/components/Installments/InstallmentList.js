                ...
                <CDataTable
                  ...
                  scopedSlots = {{
                    ...
                    'product': (item) => (
                      <td className="row">
                        <div className="col-4">
                          <img className="w-100" src={item.product.id.bigimage ? item.product.id.bigimage.publicUrl : INITIAL_IMAGE} alt={item.product.id.name}></img>
                        </div>
                        <div className="col-8 align-self-center">
                    <p className="font-weight-bold mb-0">{item.product.id.name}</p>
