...
var CListGroup = function CListGroup(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'list-group', (_classNames = {}, _classNames["list-group-horizontal-" + horizontal] = horizontal, _classNames['list-group-flush'] = flush, _classNames['list-group-accent'] = accent, _classNames));
...
CListGroup.propTypes = process.env.NODE_ENV !== "production" ? {
