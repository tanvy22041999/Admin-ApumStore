...
var CBadge = function CBadge(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'badge', (_classNames = {}, _classNames["badge-" + color] = color, _classNames["badge-" + shape] = shape, _classNames));
...
CBadge.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  shape: _propTypes["default"].oneOf(['', 'pill'])
} : {};
CBadge.defaultProps = {
  tag: 'span'
};
