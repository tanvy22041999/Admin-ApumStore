...
var CCallout = function CCallout(props) {
  ...
  var classes = (0, _classnames["default"])('c-callout', color ? 'c-callout-' + color : null, className);
...
CCallout.propTypes = process.env.NODE_ENV !== "production" ? {
