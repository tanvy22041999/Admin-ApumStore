...
var CBreadcrumbItem = function CBreadcrumbItem(props) {
  ...
  var classes = (0, _classnames["default"])(className, active ? 'active' : false, 'breadcrumb-item');
...
CBreadcrumbItem.propTypes = process.env.NODE_ENV !== "production" ? {
