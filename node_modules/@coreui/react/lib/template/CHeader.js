...
var CHeader = function CHeader(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'c-header', colorScheme ? 'c-header-' + colorScheme : null, fixed ? 'c-header-fixed' : null, withSubheader ? 'c-header-with-subheader' : null);
...
CHeader.propTypes = process.env.NODE_ENV !== "production" ? {
  ...
  withSubheader: _propTypes["default"].bool,
