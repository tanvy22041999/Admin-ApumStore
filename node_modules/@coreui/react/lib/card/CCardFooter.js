...
var CCardFooter = function CCardFooter(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'card-footer', align ? "text-" + align : false, textColor ? "text-" + textColor : false, color ? "bg-" + color : false, borderColor ? "border-" + borderColor : false);
...
CCardFooter.propTypes = process.env.NODE_ENV !== "production" ? _extends({
