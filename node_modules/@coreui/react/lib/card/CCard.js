...
exports["default"] = exports.sharedPropTypes = void 0;
...
var CCard = function CCard(props) {
  ...
  var classes = (0, _classnames["default"])(className, 'card', align ? "text-" + align : false, textColor ? "text-" + textColor : false, color ? "bg-" + color : false, borderColor ? "border-" + borderColor : false, accentColor ? "card-accent-" + accentColor : false);
...
exports.sharedPropTypes = sharedPropTypes;
CCard.propTypes = process.env.NODE_ENV !== "production" ? _extends({
