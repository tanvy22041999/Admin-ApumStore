    ...
    <script>
      ...
      btnPreventModal.addEventListener('click', function () {
        function shownFirefoxModal() {
          modalFf.hide()
          firefoxModal.removeEventListener('shown.coreui.modal', hideFirefoxModal)
        }

        function hideFirefoxModal(event) {
          event.preventDefault()
          firefoxModal.removeEventListener('hide.coreui.modal', hideFirefoxModal)
        ...
        firefoxModal.addEventListener('shown.coreui.modal', shownFirefoxModal)
        firefoxModal.addEventListener('hide.coreui.modal', hideFirefoxModal)
        modalFf.show()
      })
      ...
      slowModal.addEventListener('shown.coreui.modal', function () {
        t1 = performance.now()
        console.log('transition-duration took ' + (t1 - t0) + 'ms.')
      })

      slowModal.addEventListener('show.coreui.modal', function () {
        t0 = performance.now()
      })
    </script>
  </body>
